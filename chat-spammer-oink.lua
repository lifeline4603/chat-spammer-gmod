...
oink.ui_context("chat-spammer.lua")

oink.ui_button("oink spam/advert") -- we do buttons because i couldn't get checkboxes to work with timers
oink.ui_button("hvh talk")
oink.ui_button("toxic talk")
oink.ui_button("bible quotes")
oink.ui_button("gir489 quotes (extreme racism)")
oink.ui_button("cheadle spam")
oink.ui_button("newgen spam")
oink.ui_button("ryan fournier spam")
oink.ui_button("femboy spam (extreme nsfw)")
oink.ui_button("shabeel spam")
oink.ui_button("cat spam")
...
oink.event_remove("view_render_post", "chatSpammerEH")
...
local rate = oink.ui_get("chat-spammer.lua", "rate (incr. 0.5)")
	...
	if oink.ui_get("chat-spammer.lua", "gir489 quotes (extremely racist)") then
        oink.log(0xff0000ff, "[chat-spammer.lua] to be in compliance of github's acceptable use policies, this spammer is removed.")
        oink.log(0xff0000ff, "[chat-spammer.lua] if you want the uncensored version, you can ask lifeline4603 on discord or do one yourself.")
	end
	...
	if oink.ui_get("chat-spammer.lua", "custom spam") then
