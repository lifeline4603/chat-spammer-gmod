...
local TOXICTALK_CHATMESSAGES = {
	...
	"EZZZZZZZZZZZZZZZZZ EZZZZZZZZZZZZZ NO SECRETSERVICE.CLUB NO TALK",
...
secret.create_checkbox("lua", "elements", "OOC spam", "cOOC") -- thank you guy for a sercet sub - shiba
...
if secret.config_get("bOink") then
	timer.Create( "oink_spammer", _sRate, 0, function()
		...
		if secret.config_get("cOOC") then
