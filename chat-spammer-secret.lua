...
secret.create_checkbox("lua", "elements", "gir489 Quotes (Extreme Racism)", "bGir")
secret.create_checkbox("lua", "elements", "Bible Spam", "bBible")
secret.create_checkbox("lua", "elements", "Cheadleware Spam", "bCheadleware")
secret.create_checkbox("lua", "elements", "NewGen Spam", "bNewGen")
secret.create_checkbox("lua", "elements", "RyanFournier Spam", "bRyanFournier")
secret.create_checkbox("lua", "elements", "Femboy Spam (Extreme NSFW)", "bFemboy")
secret.create_checkbox("lua", "elements", "Shabeel Spam", "bShabeel")
